  ...
  return (
    <main className="min-h-screen bg-[#050505] text-white relative font-sans flex flex-col items-center justify-center overflow-hidden">
      ...
      <section className="relative w-full h-screen overflow-hidden hero-bg-gradient noise-overlay">
        ...
        <img
          className="absolute bottom-[-450px] left-1/2 -translate-x-1 h-[150vh] object-contain z-[3] hero-image-anim drop-shadow-[0_20px_50px_rgba(0,0,0,0.5)]"
        ...
        <div className="absolute bottom-0 left-0 right-0 h-[300px] z-[10] hero-overlay-bg pointer-events-none"></div>

        {/* Left content */}
        <div className="absolute top-150 -translate-y-1/2 left-[5%] xl:left-[60px] z-[5] max-w-[380px] hero-left-anim">
          <p className="text-[#b0b0c0] text-[25px] leading-[1.6] mb-6 font-instrument">
        ...
        {/* Right content */}
        <div className="absolute top-150 -translate-y-1/2 right-[5%] xl:right-[60px] z-[5] max-w-[380px] text-left hero-right-anim">
          <p className="text-[#b0b0c0] text-[25px] leading-[1.6] mb-6 font-instrument">
