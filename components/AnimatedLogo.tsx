...
export default function AnimatedLogo() {
  ...
  return (
    <motion.div 
      className="relative w-80 h-80 bg-[#120822] rounded-[2.5rem] flex items-center justify-center overflow-visible"
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-[#3b1a6b] to-transparent opacity-30 mix-blend-overlay rounded-[2.5rem]" />
      ...
      <motion.div variants={floatVariants} animate="animate" className="absolute inset-0 flex items-center justify-center">
        ...
        <div className="absolute inset-0 flex items-center justify-center pb-12">
          <svg viewBox="0 0 200 200" className="w-64 h-64 overflow-visible drop-shadow-lg">
            <defs>
        ...
        >
          <span 
            className="font-display text-[2.5rem] tracking-wider text-white block"
            style={{
